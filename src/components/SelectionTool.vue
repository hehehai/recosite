...
<template>
  <div
    class="fixed inset-0 z-[999999] cursor-crosshair"
  ...
  >
    ...
    <!-- 选区 -->
    <div
      v-if="isDrawing && selectionArea.width > 0 && selectionArea.height > 0"
      class="absolute border-2 border-blue-500 bg-blue-500/10"
      :style="selectionStyle"
    >
      <!-- 尺寸提示 -->
      <div
        class="absolute -top-8 left-0 rounded bg-blue-500 px-2 py-1 text-xs text-white"
      >
