    ...
    <Teleport to="body">
        <Transition enter-active-class="transition-opacity duration-200"
            ...
            <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4"
                ...
                <div class="w-full max-w-4xl max-h-[90vh] overflow-hidden rounded-xl bg-white shadow-2xl dark:bg-gray-800"
                    @click.stop>
                    <!-- Header -->
                    <div
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700">
                        <nav class="flex gap-4 px-6">
                            <button type="button" class="border-b-2 px-1 py-3 text-sm font-medium transition"
                                :class="activeTab === 'overview'
                                    ? 'border-blue-500 text-blue-600 dark:text-blue-400'
                                    : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300'" @click="activeTab = 'overview'">
                                概览
                            </button>
                            <button type="button" class="border-b-2 px-1 py-3 text-sm font-medium transition"
                                :class="activeTab === 'tracks'
                                    ? 'border-blue-500 text-blue-600 dark:text-blue-400'
                                    : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300'" @click="activeTab = 'tracks'">
                                轨道信息
                            </button>
                            <button type="button" class="border-b-2 px-1 py-3 text-sm font-medium transition"
                                :class="activeTab === 'tags'
                                    ? 'border-blue-500 text-blue-600 dark:text-blue-400'
                                    : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300'" @click="activeTab = 'tags'">
                                元数据标签
                            </button>
                        </nav>
                    </div>
                    ...
                    <div class="overflow-y-auto p-6" style="max-height: calc(90vh - 180px)">
                        ...
                        <div v-else-if="error" class="flex items-center justify-center py-12">
                            <div class="text-center">
                                <svg class="mx-auto size-12 text-red-500" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div v-else-if="activeTab === 'tracks' && metadata" class="space-y-4">
                            <div v-for="(track, index) in metadata.tracks" :key="index"
                                class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-900">
                                    ...
                                    <template v-if="track.colorSpace">
                                        <div class="col-span-2">
                                            ...
                                            <dd class="mt-1 space-y-1 text-gray-900 dark:text-white">
                                                <p>
                                                    <span class="text-gray-500 dark:text-gray-400">色域:</span>
                                                    {{
                                                        track.colorSpace.primaries || '未知' }}
                                                </p>
                                                <p>
                                                    <span class="text-gray-500 dark:text-gray-400">传输特性:</span>
                                                    {{
                                                        track.colorSpace.transfer || '未知' }}
                                                </p>
                                                <p>
                                                    <span class="text-gray-500 dark:text-gray-400">矩阵系数:</span>
                                                    {{
                                                        track.colorSpace.matrix || '未知' }}
                                                </p>
                                                <p>
                                                    <span class="text-gray-500 dark:text-gray-400">全范围:</span>
                                                    {{
                        ...
                        <div v-else-if="activeTab === 'tags' && metadata" class="space-y-4">
                            <div v-if="metadata.tags && Object.keys(metadata.tags).length > 0"
                                class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-900">
