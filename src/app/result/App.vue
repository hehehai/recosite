    ...
    <div class="flex min-h-screen flex-col bg-gray-50 dark:bg-gray-950">
        ...
        <header class="border-b border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
            <div class="mx-auto max-w-screen-2xl px-6 py-4">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-4">
                        <div
                            ...
                            <svg v-if="resultType === 'image'" class="size-6 text-white" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                            </svg>
                            <svg v-else class="size-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <!-- 文件信息 -->
                <div v-if="!loading && !error" class="mt-4 flex flex-wrap gap-6 text-sm">
                    ...
                    <div v-if="resultType === 'image'" class="flex items-center gap-2">
                        <span class="font-medium text-gray-700 dark:text-gray-300">尺寸:</span>
                        <span
        ...
        <main class="flex flex-1 overflow-hidden">
            ...
            <div v-else-if="error" class="flex flex-1 items-center justify-center p-8">
                <div
                    ...
                    <svg class="mx-auto size-12 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div v-else-if="mediaData" class="flex flex-1 gap-6 overflow-hidden p-6">
                ...
                <div
                    ...
                    <div class="flex flex-1 items-center justify-center overflow-auto bg-gray-50 p-6 dark:bg-gray-950">
                        <!-- 图片预览 -->
                        <img v-if="resultType === 'image'" :src="mediaData" :alt="fileName"
                            class="max-h-full max-w-full rounded shadow-lg">

                        <!-- 视频预览（预留） -->
                        <video v-else :src="mediaData" controls class="max-h-full max-w-full rounded shadow-lg" />
                    </div>
                </div>
                ...
                <div class="w-80 flex-shrink-0 space-y-4">
                    ...
                    <div
                        ...
                        <div class="space-y-2">
                            <button type="button"
                                ...
                                <svg v-if="!copySuccess" class="size-5" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <span>{{ copySuccess ? '已复制' : (resultType === 'image' ? '复制到剪贴板' : '下载视频') }}</span>
                            </button>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="space-y-2">
                            <button v-for="format in availableFormats" :key="format" type="button"
                                :disabled="exportingFormat === format" :class="[
                                ...
                                <span class="flex items-center gap-2">
                                    <svg v-if="exportingFormat !== format" class="size-5" fill="none"
                                        stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <span v-if="format === originalFormat"
                    ...
                    <div
                        ...
                        <div class="flex gap-3">
                            <svg class="size-5 flex-shrink-0 text-blue-500" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="p-4">
                            <div class="flex items-start">
                                <div class="flex-shrink-0">
                                    <svg v-if="notification.type === 'success'" class="size-6 text-green-400"
                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                    <svg v-else-if="notification.type === 'error'" class="size-6 text-red-400"
                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                    <svg v-else class="size-6 text-blue-400" fill="none" viewBox="0 0 24 24"
                                        stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
