...
<template>
  ...
  <div class="w-80 p-4 bg-white dark:bg-gray-900">
    ...
    <div
      v-if="lastResult"
      class="mt-4 rounded-lg bg-green-50 dark:bg-green-900/30 p-3"
    >
    ...
    <div class="mt-6 space-y-3">
      ...
      >
        <div class="font-medium">
          <span v-if="recordingState === RecordingState.IDLE"
            >开始录制 (WebM)</span
          >
          <span v-else-if="recordingState === RecordingState.RECORDING"
            >⏺ 停止录制</span
          >
